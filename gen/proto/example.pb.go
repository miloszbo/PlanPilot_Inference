...
const file_proto_example_proto_rawDesc = "" +
	"\n" +
	"\x13proto/example.proto\x12\x05hello\"\"\n" +
	...
	"\aGreeter\x122\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x11.hello.HelloReplyBDZB github.com/Cyber-Nomad-Collective/PlanPilot_Interface/gen;hellov1b\x06proto3"
...
var (
	file_proto_example_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	file_proto_example_proto_goTypes  = []any{
